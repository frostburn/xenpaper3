...
- Preserve exact pitch expressions when possible. When an expression is real,
  project its floating-point cent value onto the `Monomial` power-of-two axis
  so real quantities remain playable.
